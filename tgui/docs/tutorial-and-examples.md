...
```
ui_interact(mob/user, datum/tgui/inferno/ui)
ui_data(mob/user)
...
```dm
/obj/machinery/my_machine/ui_interact(mob/user, datum/tgui/inferno/ui)
...
```dm
/obj/copypasta/ui_interact(mob/user, datum/tgui/inferno/ui)
  ui = SStgui.try_update_ui(user, src, ui)
  if(!ui)
