...
export const Terminal = (_props, context) => {
  ...
  let navigateHistory = function (direction, DOMInput) {
    ...
    if (hasMoreHistory) {
      ...
      // setTextInput *should* have been good enough but sometimes,
      // after editing the input, it fails to update,
  ...
  let handleScrollBottom = function () {
    // There might be a better way than this setTimeout like fashion
    // to run our js scroll code at the right time
