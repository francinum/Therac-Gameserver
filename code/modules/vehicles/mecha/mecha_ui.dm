...
/obj/vehicle/sealed/mecha/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/obj/vehicle/sealed/mecha/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
	if(!(usr in occupants))
