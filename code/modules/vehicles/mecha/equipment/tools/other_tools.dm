...
/obj/item/mecha_parts/mecha_equipment/repair_droid/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(action != "toggle")
		return
	chassis.cut_overlay(droid_overlay)
...
/obj/item/mecha_parts/mecha_equipment/thrusters/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(params["toggle"])
