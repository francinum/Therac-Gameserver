...
/obj/item/circuit_component/signal_handler/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/obj/item/circuit_component/signal_handler/ui_act(action, list/params, datum/tgui/inferno/ui)
	. = ..()
	if(.)
		return
