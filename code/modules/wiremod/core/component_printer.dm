...
/obj/machinery/component_printer/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/obj/machinery/debug_component_printer/ui_interact(mob/user, datum/tgui/inferno/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "ComponentPrinter", name)
		ui.open()
...
/obj/machinery/module_duplicator/ui_interact(mob/user, datum/tgui/inferno/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "ComponentPrinter", name)
		ui.open()
