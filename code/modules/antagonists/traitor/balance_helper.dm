...
/datum/traitor_objective_debug/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/datum/traitor_objective_debug/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
