...
/obj/machinery/computer/libraryconsole/ui_interact(mob/user, datum/tgui/inferno/ui)
	. = ..()
...
/obj/machinery/libraryscanner/ui_interact(mob/user, datum/tgui/inferno/ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
...
/obj/machinery/libraryscanner/ui_act(action, params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
	switch(action)
