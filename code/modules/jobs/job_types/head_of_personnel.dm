...
<li>Select a template from the drop-down. This will apply as many <b>basic</b> accesses to the card.</li>
<li>Manually tweak any other accesses as necessary. Tweak basic accesses.</li>
