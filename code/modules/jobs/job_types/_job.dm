...
/datum/job/proc/get_spawn_mob(client/player_client, atom/spawn_point, mob/fallback_mob)
	...
	if(ispath(spawn_type, /mob/living/silicon/ai))
		...
		spawn_instance = new spawn_type(player_client?.mob.loc || fallback_mob.loc)
