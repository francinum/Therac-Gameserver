...
/datum/mafia_controller/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
...
/datum/mafia_controller/ui_interact(mob/user, datum/tgui/inferno/ui)
