...
/datum/paintings_manager/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/datum/paintings_manager/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	if(..())
		return
	if (!check_rights(R_ADMIN))
		return
