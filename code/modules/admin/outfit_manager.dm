...
/datum/outfit_manager/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/datum/outfit_manager/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	if(..())
		return
	. = TRUE
