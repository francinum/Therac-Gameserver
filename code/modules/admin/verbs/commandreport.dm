...
/datum/command_report_menu/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/datum/command_report_menu/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
