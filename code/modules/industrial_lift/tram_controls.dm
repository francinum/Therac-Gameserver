...
/obj/machinery/computer/tram_controls/ui_status(mob/user,/datum/tgui/inferno/ui)
...
/obj/machinery/computer/tram_controls/ui_interact(mob/user, datum/tgui/inferno/ui)
	. = ..()
