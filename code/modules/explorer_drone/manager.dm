...
/datum/adventure_browser/ui_interact(mob/user, datum/tgui/inferno/ui)
	. = ..()
...
/datum/adventure_browser/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
	feedback_message = ""
