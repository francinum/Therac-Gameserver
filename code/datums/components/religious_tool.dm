...
/datum/component/religious_tool/ui_interact(mob/user, datum/tgui/inferno/ui)
...
/datum/component/religious_tool/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	switch(action)
		if("sect_select")
