...
/datum/component/uplink/ui_interact(mob/user, datum/tgui/inferno/ui)
	active = TRUE
...
/datum/component/uplink/ui_act(action, params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if(.)
		return
	if(!active)
