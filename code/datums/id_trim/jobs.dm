...
/datum/access_template/job/captain/New()
	...
	access |= SSid_access.get_flag_access_list(ACCESS_FLAG_COMMAND)
	access |= SSid_access.get_flag_access_list(ACCESS_FLAG_PRV_COMMAND)
	access |= SSid_access.get_flag_access_list(ACCESS_FLAG_CAPTAIN)
	return ..()
