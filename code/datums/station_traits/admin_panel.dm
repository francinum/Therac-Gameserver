...
/datum/station_traits_panel/ui_act(action, list/params, datum/tgui/inferno/ui, datum/ui_state/state)
	. = ..()
	if (.)
		return
...
/datum/station_traits_panel/ui_interact(mob/user, datum/tgui/inferno/ui)
