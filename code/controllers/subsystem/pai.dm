...
/datum/controller/subsystem/pai/ui_interact(mob/user, datum/tgui/inferno/ui)
	. = ..()
...
/datum/controller/subsystem/pai/ui_act(action, list/params, datum/tgui/inferno/ui)
	. = ..()
	if(.)
		return
	/// The matching candidate from search
